  ...
  return (
    <div className="bg-white">
      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        {/* <h1 className="text-4xl font-bold tracking-tight text-gray-900 text-center mb-10">Trending Now</h1>      */}
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
            {trandingData.results && trandingData.results.map((trandingData) => (
                <div className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow  md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700" key={trandingData.id}>
